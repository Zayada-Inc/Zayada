...
namespace Persistence.Data.DataSeeder
{
    public static class DataSeeder
    {
        ...
        public static async Task Seed(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, IMediator mediator,DataContext dbContext,IGenericRepository<PersonalTrainer> genericRepository)
        {
            await SeedAdminUser(userManager, roleManager);
            await SeedUsers(userManager, mediator);
            await SeedGyms(userManager, roleManager, dbContext,genericRepository);
        }
        ...
        private static async Task SeedGyms(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, DataContext dbContext,IGenericRepository<PersonalTrainer> genericRepository)
        {
            try
            {
                int numberOfGyms = 10;
